...
<body>
    ...
    <div class="container">
        ...
        <ul class="list-group" style="margin-top: 15px;">
            ...
            <li class="list-group-item" id="list2" style="margin-top: 5px;"><center>Menu Wise Sale Report</center></li>
        ...
        <div>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td style="text-align: center;"><?php echo $_POST['menu_name'] ?></td>
    ...
    <script>
        ...
        document.getElementById('back').addEventListener('click' , function(){
            ...
            window.location.href = "menu-report.php";
