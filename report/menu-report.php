...
<body>
    ...
    <div id="demo">
        ...
        <form method="POST" action="second.php">
            ...
            <input list="hosting-plan" type="text" name="menu_name" style="margin-top: 20px; width: 50%;" class="form-control">

            <datalist id="hosting-plan">
                <!-- Fetching of file from database -->
                <option>
                    <?php while ($rows = $Select->fetch_assoc()) { ?>
                
                        <option><?php echo $rows['menu_name']; ?></option>
                ...
                <br>
            <button type="submit" id="print" name="button" class="btn btn-primary">Next</button>
