...
<body>
    ...
    <div class="container">
        ...
        <ul class="list-group" style="margin-top: 15px;">
            ...
            <li class="list-group-item" id="list2" style="margin-top: 5px;"><center>Sale Report</center></li>
            <li class="list-group-item" style="margin-top: 5px;">

                <label style="font-size: 14px; margin-bottom: 0px;">From Date: <?php  echo $_POST['fdate'] ?></label>
    ...
    <script>
        ...
        document.getElementById('back').addEventListener('click' , function(){
            ...
            window.location.href = "paidReport.php";
