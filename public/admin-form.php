          	...
          	<div class="container">
            	<div class="row">
              		<div class="col s12 m12 l12">
               			<h5 class="breadcrumbs-title">تنظیمات</h5>
		                <ol class="breadcrumb">
		                  <li><a href="dashboard.php">صفحه اصلی</a>
		                  </li>
		                  <li><a href="#" class="active">تنظیمات</a>
		                  </li>
		                </ol>
              		</div>
            	</div>
		                    			...
		                    			<div class="input-field col s12">   
											...
											<div class="row">
						                      <div class="input-field col s12">
						                        ...
						                        <label for="email">ایمیل آدرس</label><?php echo isset($error['email']) ? $error['email'] : '';?>
						                      </div>
						                    </div>
											...
											<div class="row">
						                      <div class="input-field col s12">
						                        ...
						                        <label for="old_password">رمز قدیمی</label><?php echo isset($error['old_password']) ? $error['old_password'] : '';?>
						                      </div>
						                    </div>
											...
											<div class="row">
						                      <div class="input-field col s12">
						                        ...
						                        <label for="new_password">رمز جدید</label><?php echo isset($error['new_password']) ? $error['new_password'] : '';?>
						                      </div>
						                    </div>  
											...
											<div class="row">
						                      <div class="input-field col s12">
						                        ...
						                        <label for="confirm_password">تایپ دوباره رمز جدید</label><?php echo isset($error['confirm_password']) ? $error['confirm_password'] : '';?>
						                      </div>
						                    </div>	


											<button class="btn cyan waves-effect waves-light right" type="submit" name="btnChange">جدید کردن
