          	...
          	<div class="container">
            	<div class="row">
              		<div class="col s12 m12 l12">
               			<h5 class="breadcrumbs-title">اضافه کردن منو</h5>
		                <ol class="breadcrumb">
		                  <li><a href="dashboard.php">صفحه اصلی</a>
		                  </li>
		                  <li><a href="#" class="active">اضافه کردن منو</a>
		                  </li>
		                </ol>
              		</div>
            	</div>
								                ...
								                <div class="col s12 m12 l5">
								                  <div class="card-panel">
								                      ...
								                      <div class="input-field col s12">
								                        ...
								                        <label for="menu_name">نام منو</label><?php echo isset($error['menu_name']) ? $error['menu_name'] : '';?>
								                      </div>
								                    </div>
													...
													<div class="row">
								                      <div class="input-field col s12">
								                        ...
								                        <label for="price">قیمت (AFG)</label><?php echo isset($error['price']) ? $error['price'] : '';?>
								                      </div>
								                    </div>
								                    ...
								                    <div class="row">
								                      <div class="input-field col s12">
								                        ...
								                        <label for="serve_for">سرو میشود برای (نفر)</label><?php echo isset($error['serve_for']) ? $error['serve_for'] : '';?>
								                      </div>
								                    </div>
								                    ...
								                    <div class="row">
			                                            ...
			                                            <select name="menu_status">
															...
															<option>برای فروش نیست</option>
			                                            </select>
			                                            <label>حالت</label><?php echo isset($error['menu_status']) ? $error['menu_status'] : '';?></div>	
		                                        	</div>
        ...
        <a name="basic-multiple-fields"></a>
            <div class=" ">
                <input class="form-control" id="test<?php echo $test_index ?>" value="2" />
				                                            ...
				                                            <label>کتگوری</label><?php echo isset($error['category_id']) ? $error['category_id'] : '';?>
			                                            </div>			                                         
			                                        </div>
						                ...
						                <div class="col s12 m12 l7">
						                  <div class="card-panel">
						                    ...
						                    <div class="row">
						                      <div class="input-field col s12">
						                      <span class="grey-text text-grey lighten-2">توضیحات منو</span> 
											...
											<div class="input-field col s12">
											  <button class="btn cyan waves-effect waves-light right"
	                                                type="submit" name="btnAdd">تایید شد
