	...
	<?php 
		...
		if(empty($keyword)){
			$sql_query = "SELECT order_id, waiter_name, number_of_people, date_time, phone, res_status
				FROM order_list_view where category_id = 2  and res_status = 0 group by order_id 
          	...
          	<div class="container">
            	<div class="row">
              		<div class="col s12 m12 l12">
               			<h5 class="breadcrumbs-title">مدیریت قلیان</h5>
		                <ol class="breadcrumb">
											...
											<?php 
												...
												<tbody>
													<tr>
														...
														<td><div align="right">
															<a href="detail-reservation-qail.php?id=<?php echo $data['order_id'];?>">
