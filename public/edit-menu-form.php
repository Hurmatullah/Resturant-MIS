          	...
          	<div class="container">
            	<div class="row">
              		<div class="col s12 m12 l12">
               			<h5 class="breadcrumbs-title">ویرایش منو</h5>
		                <ol class="breadcrumb">
		                  <li><a href="dashboard.php">صفحه اصلی</a>
		                  </li>
		                  <li><a href="#" class="active">ویرایش منو</a>
		                  </li>
		                </ol>
              		</div>
            	</div>
								                ...
								                <div class="col s12 m12 l5">
								                  <div class="card-panel">
								                      ...
								                      <div class="input-field col s12">
								                        ...
								                        <label for="price">قیمت (<?php echo $currency;?>)</label><?php echo isset($error['price']) ? $error['price'] : '';?>
								                      </div>
						                  ...
						                  <div class="card-panel">
											...
											<div class="input-field col s12">
											  <button class="btn cyan waves-effect waves-light right"
	                                                type="submit" name="btnEdit">جدید کردن
