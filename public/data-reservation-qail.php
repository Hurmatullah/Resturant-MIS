          	...
          	<div class="container">
            	<div class="row">
              		<div class="col s12 m12 l12">
               			<h5 class="breadcrumbs-title">جزئیات سفارشات - قلیان</h5>
		                <ol class="breadcrumb">
...
<?php
	...
	$s = mysqli_query($conn,"select * from order_list_view where res_status = 0 AND order_id='$ID' and category_id = 2  group by order_id order by order_id DESC"); // شرط
 ...
 ?>
    ...
    <?php while($data = mysqli_fetch_array($s)){ ?>
		...
		<tr style="padding:0;">
			...
			$menu_list = mysqli_query($conn,"select * from order_list_view where order_id = '$data[0]' and category_id = 2 ");// شرط
			while($item = mysqli_fetch_array($menu_list)){ ?>
				   ...
				   <span style="float:left;">
					...
					<form action="public/updateorderlist-qail.php" method="POST" >
