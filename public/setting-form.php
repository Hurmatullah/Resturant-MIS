	...
	<?php 
		if(isset($_POST['btnChange'])){
			...
			if($update_result) {
				...
				$error['update_setting'] = "<div class='card-panel grey darken-1'>
											    <span class='white-text text-darken-2'>
												    Update Failed
											    </span>
											</div>";
          	...
          	<div class="container">
            	<div class="row">
              		<div class="col s12 m12 l12">
               			<h5 class="breadcrumbs-title">مالیت و واحدپولی</h5>
		                <ol class="breadcrumb">
		                  <li><a href="dashboard.php">صفحه اصلی</a>
		                  </li>
		                  <li><a href="#" class="active">مالیت و واحدپولی</a>
		                  </li>
		                </ol>
              		</div>
            	</div>
		                    			...
		                    			<div class="input-field col s12">   
											...
											<div class="row">
						                      ...
						                      <?php $previous_email = (isset($previous_email)) ? $previous_email : ''; ?>
						                        ...
						                        <label for="tax">مالیات (%)</label><?php echo isset($error['tax']) ? $error['tax'] : '';?>
						                      </div>
						                    </div>
