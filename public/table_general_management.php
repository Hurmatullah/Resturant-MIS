	...
	<?php 
		...
		if(empty($keyword)){
			$sql_query = "SELECT order_id, waiter_name, number_of_people, date_time, phone, res_status
				FROM order_list_view group by order_id 
    ...
    <section id="content">
        ...
        <div id="breadcrumbs-wrapper" class=" grey lighten-3">
          	<div class="container">
            	<div class="row">
              		<div class="col s12 m12 l12">
               			<h5 class="breadcrumbs-title">مدیریت عمومی</h5>
		                <ol class="breadcrumb">
		                  <li><a href="dashboard.php">صفحه اصلی</a>
		                  </li>
		                  <li><a href="#" class="active">لیست ریزرف</a>
		                	...
		                	<div class="row">
		                  		<div class="row">
		                    		<div class="input-field col s12">
												...
												<tbody>
													<tr>
														...
														<?php if($data['res_status'] == 0) { ?>
															...
															<?php } else if($data['res_status'] == 2) {?>
															<span class='white-text brown lighten-2'>&nbsp;&nbsp;تکمیل شد&nbsp;&nbsp;</span>
															<?php } else if($data['res_status'] == 3) {?>
															<span class='white-text black'>&nbsp;&nbsp;کنسل شد&nbsp;&nbsp;</span>
															
															<?php } ?></div>
														</td>																											
														<td><div align="right">
															<a href="detail-general-management.php?id=<?php echo $data['order_id'];?>">
										...
										<h4><?php $function->doPages($offset, 'general-management.php', '', $total_records, $keyword); ?></h4>
