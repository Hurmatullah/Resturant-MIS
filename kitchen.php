        ...
        <div id="breadcrumbs-wrapper" class=" grey lighten-3">
          	<div class="container">
            	...
            	<div class="row">
                      ...
                      <h6 class="breadcrumbs-title">آشپزخانه</h6>   			
...
<?php
	...
	$s = mysqli_query($conn,"select * from order_list_view where res_status = 0 AND category_id =1 group by order_id order by order_id DESC");
 ...
 ?>
	...
	<thead>
		...
		<th style="text-align:center;background-color:dodgerblue; color:white;">نمبر میز</th>
    ...
    <?php while($data = mysqli_fetch_array($s)){ ?>
		...
		<tr style="padding:0;">
			...
			$menu_list = mysqli_query($conn,"select * from order_list_view where order_id = '$data[0]' AND category_id =1");
